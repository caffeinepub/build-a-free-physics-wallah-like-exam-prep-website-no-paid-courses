...
export class Backend implements backendInterface {
    ...
    async searchCoursesBySubject(arg0: string): Promise<Array<Course>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchCoursesBySubject(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchLessonsByKeyword(arg0: string): Promise<Array<Lesson>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchLessonsByKeyword(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
